...
export const fetchProjects = async () => {
  const response = await fetch(`https://prod-voi.api.highforge.io/projects`);
  const data = await response.json();
  return data.results;
};
...
export const scheduleCollectionHolderSnapshot = async (
  network,
  contractId,
  snapshotTime,
  emailAddress
...
//schedule collection holder snapshot
export const scheduleArc200HolderSnapshot = async (
  network,
  tokenId,
  snapshotTime,
  emailAddress
