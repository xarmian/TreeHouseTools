...
const ExampleSidebar: FC<ExampleSidebarProps> = function ({ isSidebarOpen }) {
  ...
  return (
          ...
          style={sidebarStyle}
                >
          <div className=" font-pixel flex h-full flex-col justify-between py-1">
              {isSidebarOpen && (
                  <div>
                      <Sidebar.Items>
                      <Sidebar.ItemGroup>
                      ...
                      <Text className="mb-2 ml-1">Airdrop Collections:</Text>
                          <Sidebar.Item  as={Link}
                              ...
                              className={"/collection-airdrop" === currentPage ? "bg-gray-700" : ""}
                          >
                              Send VOI
                          </Sidebar.Item>
                          <Sidebar.Item  as={Link}
                              ...
                              icon={HiPaperAirplane}
                              className={"/arc200-collection-airdrop" === currentPage ? "bg-gray-700" : ""}
                          >
                              Send ARC - 200
                          </Sidebar.Item>
                      </Sidebar.ItemGroup>
                      ...
                      <Text className="mb-2 ml-1">Airdrop LP Holders:</Text>
                          ...
                          <Sidebar.Item  as={Link}
                              ...
                              icon={HiPaperAirplane}
                              className={"/arc200-lp-airdrop" === currentPage ? "bg-gray-700" : ""}
                          >
                              Send ARC - 200
                          </Sidebar.Item>
                      </Sidebar.ItemGroup>
                      ...
                      <Text className="mb-2 ml-1">Airdrop Token Holders:</Text>
                          <Sidebar.Item  as={Link}
                              to="/token-airdrop"
                              icon={HiPaperAirplane}
                              className={"/token-airdrop" === currentPage ? "bg-gray-700" : ""}
                          >
                              Send VOI
                          </Sidebar.Item>
                          <Sidebar.Item  as={Link}
                              ...
                              icon={HiPaperAirplane}
                              className={"/arc200-token-airdrop" === currentPage ? "bg-gray-700" : ""}
                          >
                              Send ARC - 200
                          </Sidebar.Item>
                      </Sidebar.ItemGroup>
                      ...
                      <Text className="mb-2 ml-1">Airdrop CSV List:</Text>
                          <Sidebar.Item  as={Link}
                              to="/csv-airdrop"
                              icon={HiPaperAirplane}
                              className={"/csv-airdrop" === currentPage ? "bg-gray-700" : ""}
                          >
                              Send VOI
                          </Sidebar.Item>
                          <Sidebar.Item  as={Link}
                      ...
                      <Text className="mb-2 ml-1">Snapshots:</Text>
                          <Sidebar.Item  as={Link}
                              ...
                              icon={HiCamera}
                              className={"/collection-snapshot" === currentPage ? "bg-gray-700" : ""}
                          >
                              Collection
                          </Sidebar.Item>
                          <Sidebar.Item  as={Link}
                              to="/arc200-snapshot"
                              icon={HiCamera}
                              className={"/arc200-snapshot" === currentPage ? "bg-gray-700" : ""}
                          >
                              ARC - 200 
                          </Sidebar.Item>
                          <Sidebar.Item  as={Link}
                              to="/lp-snapshot"
                              icon={HiCamera}
                              className={"/lp-snapshot" === currentPage ? "bg-gray-700" : ""}
                          >
                              LP Token 
                          </Sidebar.Item>    
                          </Sidebar.ItemGroup>
