...
<Button size='lg' className='mt-6 w-40' onClick={handleSendAlgo} type='button' loading={loading} 
        disabled={loading || (Number(formatArc200Amount((amountPerHolderNFT), tokenDecimals)) == 0) || totalCost === 0 || totalFees === 0 || amountPerHolderNFT === 0 || totalCost / multiplicationFactor >= balance || totalFees >= voiBalance / 1000000}>
  Send it!
</Button>
