    ...
    return (
            ...
            <Grid numItemsSm={1} numItemsLg={1} className="flex justify-center">
                <Card className="max-w-screen-lg flex flex-col items-center">
                    <div className="flex items-center">
                        <Metric className="mb-4 text-center font-pixel ml-16 flex-grow">VOI LP Airdropper</Metric>
        ...
        <Text>Amount per Provider</Text>
                    ...
                    <div className="flex flex-col items-center justify-center space-y-2 md:flex-row md:space-y-0 md:space-x-4 mb-2">
                        ...
                        <Text className="text-center">
        <span className="font-bold">Amount per Provider:</span> {formatVoiAmount(isNaN(perHolderCost) ? 0 : perHolderCost / 1000000)} VOI
    </Text>
    <Text className="text-center">
...
export default AirdropLPComponent;
