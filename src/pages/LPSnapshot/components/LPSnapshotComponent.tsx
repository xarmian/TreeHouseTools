      ...
      <Grid numItemsSm={1} numItemsLg={1} className="flex justify-center">
        <Card className="max-w-screen-lg flex flex-col items-center">
          <div className="flex items-center">
            <Metric className="text-center font-pixel ml-16 flex-grow">LP Holders Snapshot</Metric>
  ...
  {timeOptions.map((option, index) => (
    <SearchSelectItem key={index} value={option.value}>
      {option.label}
          ...
          <Divider className='font-bold mt-10'>{isScheduled ? 'Step 5: Schedule' : 'Step 3: Download'} LP Token CSV</Divider>
          <Button 
            size='xl' 
            className='mb-2 w-40' 
            type='button' 
