...
import { Card, Button, Grid, Text, Metric, Divider, DialogPanel, Dialog, Title, SearchSelect, SearchSelectItem } from '@tremor/react';
...
const NFTBurnComponent: React.FC = () => {
  ...
  const receiverAddress = "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAY5HFKQ"
  ...
  return (
    <>
      <Grid numItemsSm={1} numItemsLg={1} className="flex justify-center">
        ...
        <div className="flex items-center">
            <Metric className="mb-4 text-center font-pixel ml-16 flex-grow">ARC-72 NFT Burner</Metric>
    ...
    <Text className="text-center">
        <span className="font-bold">VOI Balance: </span> {formatAmount(isNaN(voiBalance) ? 0 : Math.round(voiBalance / 1000000))}
          ...
          <Divider className='font-bold mt-8'>Step 1: Select NFT</Divider>
          <SearchSelect
